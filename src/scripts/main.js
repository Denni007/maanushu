...
(function () {
  ...
  const jsonData = [
    {
      "title": "How create Aamknf",
      "imageSrc": "images/posts/post-5.png",
...
jsonData.forEach(post => {
  ...
  cardTitle.classList.add('h6', 'card-title');
...
// Initialize the Swiper carousel after appending the card elements
const reviewsCarousel = new Swiper('.reviews-carousel', {
  // Your Swiper configuration options
  autoplay: {
    delay: 3000, // Auto-slide delay in milliseconds (3 seconds in this case)
    disableOnInteraction: false // Continue auto-slide even if user interacts with the carousel
  },
  loop: true,
    spaceBetween: 20,
    pagination: {
  ...
  // Loop through the links to find the one that matches the current URL path
